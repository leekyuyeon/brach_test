...
//Output Prot
#define SRAM_CARD00_SET()       {GpioDataRegs.GPACLEAR.bit.GPIO0    = 1;}    /*SRAM_CARD0*/
#define SRAM_CARD01_SET()       {GpioDataRegs.GPACLEAR.bit.GPIO1    = 1;}    /*SRAM_CARD1*/
#define SRAM_CARD02_SET()       {GpioDataRegs.GPACLEAR.bit.GPIO2    = 1;}    /*SRAM_CARD2*/
#define SRAM_CARD03_SET()       {GpioDataRegs.GPACLEAR.bit.GPIO3    = 1;}    /*SRAM_CARD3*/
#define SRAM_CARD04_SET()       {GpioDataRegs.GPACLEAR.bit.GPIO4    = 1;}    /*SRAM_CARD4*/
#define SRAM_CARD05_SET()       {GpioDataRegs.GPACLEAR.bit.GPIO5    = 1;}    /*SRAM_CARD5*/
#define SRAM_CARD06_SET()       {GpioDataRegs.GPACLEAR.bit.GPIO6    = 1;}    /*SRAM_CARD6*/
#define SRAM_CARD07_SET()       {GpioDataRegs.GPACLEAR.bit.GPIO7    = 1;}    /*SRAM_CARD7*/
#define SRAM_CARD08_SET()       {GpioDataRegs.GPACLEAR.bit.GPIO8    = 1;}    /*SRAM_CARD8*/
#define SRAM_CARD09_SET()       {GpioDataRegs.GPACLEAR.bit.GPIO9    = 1;}    /*SRAM_CARD9*/
#define SRAM_CARD10_SET()       {GpioDataRegs.GPACLEAR.bit.GPIO10   = 1;}    /*SRAM_CARD10*/
#define SRAM_CARD11_SET()       {GpioDataRegs.GPACLEAR.bit.GPIO11   = 1;}    /*SRAM_CARD11*/
#define SRAM_CARD12_SET()       {GpioDataRegs.GPACLEAR.bit.GPIO12   = 1;}    /*SRAM_CARD12*/
#define SRAM_CARD13_SET()       {GpioDataRegs.GPACLEAR.bit.GPIO13   = 1;}    /*SRAM_CARD13*/

#define SRAM_CARD14_SET()       {GpioDataRegs.GPASET.bit.GPIO16   = 1;}    /*SRAM_CARD14*/
#define SRAM_CARD15_SET()       {GpioDataRegs.GPASET.bit.GPIO17   = 1;}    /*SRAM_CARD15*/

#define COLD_ADC_CS_SET()       {GpioDataRegs.GPBCLEAR.bit.GPIO32 = 1;}    /*COLD_ADC_CS*/

#define RUN_LED_SET()           {GpioDataRegs.GPBCLEAR.bit.GPIO34 = 1;}  /*RUN_LED*/

#define COLD_CNVT_ADC_SET()     {GpioDataRegs.GPBCLEAR.bit.GPIO35 = 1;}  /*COLD_CNVT_ADC*/

#define ADC_OS2_SET()           {GpioDataRegs.GPBSET.bit.GPIO48   = 1;}    /*ADC_OS2*/
#define ADC_OS1_SET()           {GpioDataRegs.GPBSET.bit.GPIO49   = 1;}    /*ADC_OS1*/

#define TRIGGER_OUT07_SET()     {GpioDataRegs.GPBSET.bit.GPIO52   = 1;}    /*TRIGGER_OUT7*/
#define TRIGGER_OUT06_SET()     {GpioDataRegs.GPBSET.bit.GPIO53   = 1;}    /*TRIGGER_OUT6*/
#define TRIGGER_OUT05_SET()     {GpioDataRegs.GPBSET.bit.GPIO54   = 1;}    /*TRIGGER_OUT5*/
#define TRIGGER_OUT04_SET()     {GpioDataRegs.GPBSET.bit.GPIO55   = 1;}    /*TRIGGER_OUT4*/
#define TRIGGER_OUT03_SET()     {GpioDataRegs.GPBSET.bit.GPIO56   = 1;}    /*TRIGGER_OUT3*/
#define TRIGGER_OUT02_SET()     {GpioDataRegs.GPBSET.bit.GPIO57   = 1;}    /*TRIGGER_OUT2*/
#define TRIGGER_OUT01_SET()     {GpioDataRegs.GPBSET.bit.GPIO58   = 1;}    /*TRIGGER_OUT1*/
#define TRIGGER_OUT00_SET()     {GpioDataRegs.GPBSET.bit.GPIO59   = 1;}    /*TRIGGER_OUT0*/

#define DSP_RESET_ADC_SET()     {GpioDataRegs.GPBSET.bit.GPIO60 = 1;}    /*DSP_CNVT_ADC*/
#define DSP_CNVT_ADC_SET()      {GpioDataRegs.GPBCLEAR.bit.GPIO61 = 1;}    /*DSP_CNVT_ADC*/

#define SRAM_CARD00_CLEAR()     {GpioDataRegs.GPASET.bit.GPIO0  = 1;}    /*SRAM_CARD0*/
#define SRAM_CARD01_CLEAR()     {GpioDataRegs.GPASET.bit.GPIO1  = 1;}    /*SRAM_CARD1*/
#define SRAM_CARD02_CLEAR()     {GpioDataRegs.GPASET.bit.GPIO2  = 1;}    /*SRAM_CARD2*/
#define SRAM_CARD03_CLEAR()     {GpioDataRegs.GPASET.bit.GPIO3  = 1;}    /*SRAM_CARD3*/
#define SRAM_CARD04_CLEAR()     {GpioDataRegs.GPASET.bit.GPIO4  = 1;}    /*SRAM_CARD4*/
#define SRAM_CARD05_CLEAR()     {GpioDataRegs.GPASET.bit.GPIO5  = 1;}    /*SRAM_CARD5*/
#define SRAM_CARD06_CLEAR()     {GpioDataRegs.GPASET.bit.GPIO6  = 1;}    /*SRAM_CARD6*/
#define SRAM_CARD07_CLEAR()     {GpioDataRegs.GPASET.bit.GPIO7  = 1;}    /*SRAM_CARD7*/
#define SRAM_CARD08_CLEAR()     {GpioDataRegs.GPASET.bit.GPIO8  = 1;}    /*SRAM_CARD8*/
#define SRAM_CARD09_CLEAR()     {GpioDataRegs.GPASET.bit.GPIO9  = 1;}    /*SRAM_CARD9*/
#define SRAM_CARD10_CLEAR()     {GpioDataRegs.GPASET.bit.GPIO10 = 1;}    /*SRAM_CARD10*/
#define SRAM_CARD11_CLEAR()     {GpioDataRegs.GPASET.bit.GPIO11 = 1;}    /*SRAM_CARD11*/
#define SRAM_CARD12_CLEAR()     {GpioDataRegs.GPASET.bit.GPIO12 = 1;}    /*SRAM_CARD12*/
#define SRAM_CARD13_CLEAR()     {GpioDataRegs.GPASET.bit.GPIO13 = 1;}    /*SRAM_CARD13*/

#define SRAM_CARD14_CLEAR()     {GpioDataRegs.GPACLEAR.bit.GPIO16 = 1;}    /*SRAM_CARD14*/
#define SRAM_CARD15_CLEAR()     {GpioDataRegs.GPACLEAR.bit.GPIO17 = 1;}    /*SRAM_CARD15*/

#define COLD_ADC_CS_CLEAR()     {GpioDataRegs.GPBSET.bit.GPIO32   = 1;}    /*COLD_ADC_CS*/

#define RUN_LED_CLEAR()         {GpioDataRegs.GPBSET.bit.GPIO34   = 1;}  /*RUN_LED*/

#define COLD_CNVT_ADC_CLEAR()   {GpioDataRegs.GPBSET.bit.GPIO35   = 1;}  /*COLD_CNVT_ADC*/

#define ADC_OS2_CLEAR()         {GpioDataRegs.GPBCLEAR.bit.GPIO48 = 1;}    /*ADC_OS2*/
#define ADC_OS1_CLEAR()         {GpioDataRegs.GPBCLEAR.bit.GPIO49 = 1;}    /*ADC_OS1*/


#define TRIGGER_OUT07_CLEAR()   {GpioDataRegs.GPBCLEAR.bit.GPIO52 = 1;}    /*TRIGGER_OUT7*/
#define TRIGGER_OUT06_CLEAR()   {GpioDataRegs.GPBCLEAR.bit.GPIO53 = 1;}    /*TRIGGER_OUT6*/
#define TRIGGER_OUT05_CLEAR()   {GpioDataRegs.GPBCLEAR.bit.GPIO54 = 1;}    /*TRIGGER_OUT5*/
#define TRIGGER_OUT04_CLEAR()   {GpioDataRegs.GPBCLEAR.bit.GPIO55 = 1;}    /*TRIGGER_OUT4*/
#define TRIGGER_OUT03_CLEAR()   {GpioDataRegs.GPBCLEAR.bit.GPIO56 = 1;}    /*TRIGGER_OUT3*/
#define TRIGGER_OUT02_CLEAR()   {GpioDataRegs.GPBCLEAR.bit.GPIO57 = 1;}    /*TRIGGER_OUT2*/
#define TRIGGER_OUT01_CLEAR()   {GpioDataRegs.GPBCLEAR.bit.GPIO58 = 1;}    /*TRIGGER_OUT1*/
#define TRIGGER_OUT00_CLEAR()   {GpioDataRegs.GPBCLEAR.bit.GPIO59 = 1;}    /*TRIGGER_OUT0*/

#define DSP_RESET_ADC_CLEAR()   {GpioDataRegs.GPBCLEAR.bit.GPIO60 = 1;}    /*DSP_CNVT_ADC*/
#define DSP_CNVT_ADC_CLEAR()   {GpioDataRegs.GPBSET.bit.GPIO61   = 1;}    /*DSP_CNVT_ADC*/

#define RUN_LED_TOGGLE()        {GpioDataRegs.GPBTOGGLE.bit.GPIO34 = 1;}    /*RUN_LED*/

//Input Port
#define TRIGGER_IN00()           GpioDataRegs.GPADAT.bit.GPIO20          /*TRIGGER_OUT0*/
#define TRIGGER_IN01()           GpioDataRegs.GPADAT.bit.GPIO21          /*TRIGGER_OUT1*/
#define TRIGGER_IN02()           GpioDataRegs.GPADAT.bit.GPIO22          /*TRIGGER_OUT2*/
#define TRIGGER_IN03()           GpioDataRegs.GPADAT.bit.GPIO23          /*TRIGGER_OUT3*/
#define TRIGGER_IN04()           GpioDataRegs.GPADAT.bit.GPIO24          /*TRIGGER_OUT4*/
#define TRIGGER_IN05()           GpioDataRegs.GPADAT.bit.GPIO25          /*TRIGGER_OUT5*/
#define TRIGGER_IN06()           GpioDataRegs.GPADAT.bit.GPIO26          /*TRIGGER_OUT6*/
#define TRIGGER_IN07()           GpioDataRegs.GPADAT.bit.GPIO27          /*TRIGGER_OUT7*/

#define BUSY_ADC()               GpioDataRegs.GPBDAT.bit.GPIO51		    /*ADC_OS0*/

#define nWE0_SET()				{GpioDataRegs.GPBSET.bit.GPIO38   = 1;}	/*nWE*/
#define nWE0_CLEAR()			{GpioDataRegs.GPBCLEAR.bit.GPIO38   = 1;}	/*nWE*/
