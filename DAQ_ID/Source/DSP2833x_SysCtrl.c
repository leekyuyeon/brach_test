...
#include "..\Header\DSP2833x_Device.h"     // Headerfile Include File
#include "..\Header\DSP2833x_Examples.h"   // Examples Include File
...
// HISPCP/LOSPCP prescale register settings, normally it will be set to default values
   ...
   SysCtrlRegs.LOSPCP.all = 0x0000;//0x0002; bgkim add
